...
#define SEG_DIG1_Pin GPIO_PIN_5
#define SEG_DIG1_GPIO_Port GPIOC
...
#define SEG_DIG2_Pin GPIO_PIN_6
#define SEG_DIG2_GPIO_Port GPIOC
#define SEG_DIG3_Pin GPIO_PIN_8
#define SEG_DIG3_GPIO_Port GPIOC
#define SEG_DP_Pin GPIO_PIN_11
#define SEG_DP_GPIO_Port GPIOA
#define SEG_DIG0_Pin GPIO_PIN_12
#define SEG_DIG0_GPIO_Port GPIOA
